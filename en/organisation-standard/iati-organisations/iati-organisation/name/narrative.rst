...
This is the reference page for the XML element ``narrative``. See also the relevant overview pages: :doc:`/organisation-standard/overview/organisations`,  :doc:`/organisation-standard/overview/iati-organisation` 
