...
This is the reference page for the XML element ``period-start``. See also the relevant overview pages: :doc:`/activity-standard/overview/dates`,  :doc:`/activity-standard/overview/budgets` 
