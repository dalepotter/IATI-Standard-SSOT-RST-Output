...
This is the reference page for the XML element ``narrative``. See also the relevant overview pages: :doc:`/activity-standard/overview/conditions`,  :doc:`/activity-standard/overview/conditions` 
